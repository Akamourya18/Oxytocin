...
function addListIml(board) {
  return function () {
    var titleInput = document.getElementById('iml-list-title-input');

    document.getElementById('iml-list-title-submit').onclick = titleButtonClick;
